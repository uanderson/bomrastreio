...
<head>
  ...
  <title>Objeto ${code} atrasado</title>
...
<body class="">
  <table border="0" cellpadding="0" cellspacing="0" class="body">
    <tr>
      ...
      <td class="container">
        <div class="content">
          <span class="preheader">Objeto ${code} atrasado</span>
          <table class="main">
            <tr>
              <td class="wrapper">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                      <p>Olá,</p>
                      <p>O seu objeto ${code} ainda não chegou ao seu destino. Não se preocupe! Ficaremos de olho pra você.</p>
